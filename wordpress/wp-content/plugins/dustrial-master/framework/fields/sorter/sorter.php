 ...
 *
 */
class DUSTRIALFramework_Option_Sorter extends DUSTRIALFramework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : esc_html__( 'Enabled Modules', 'dustrial-framework' );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : esc_html__( 'Disabled Modules', 'dustrial-framework' );

    echo '<div class="dustrial-modules">';
    echo '<h3>'. $enabled_title .'</h3>';
    echo '<ul class="dustrial-enabled">';
    if( ! empty( $enabled ) ) {
    ...
    echo '<ul class="dustrial-disabled">';
    if( ! empty( $disabled ) ) {
