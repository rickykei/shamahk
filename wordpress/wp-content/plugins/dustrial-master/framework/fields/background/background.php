 ...
 *
 */
class DUSTRIALFramework_Option_background extends DUSTRIALFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : esc_html__( 'Upload', 'dustrial-framework' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : esc_html__( 'Upload', 'dustrial-framework' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : esc_html__( 'Use Image', 'dustrial-framework' );

    echo '<div class="dustrial-field-upload">';
    echo '<input type="text" name="'. $this->element_name( '[image]' ) .'" value="'. $this->value['image'] .'"'. $this->element_class() . $this->element_attributes() .'/>';
    echo '<a href="#" class="button dustrial-add" data-frame-title="'. $frame_title .'" data-upload-type="'. $upload_type .'" data-insert-title="'. $insert_title .'">'. $button_title .'</a>';
    echo '</div>';

    // background attributes
    echo '<fieldset>';
    echo dustrial_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
