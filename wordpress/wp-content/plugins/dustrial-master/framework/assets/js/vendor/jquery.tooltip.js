...
+function ($) {
  ...
  CSTooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="dustrial-tooltip" role="tooltip"><div class="dustrial-tooltip-arrow"></div><div class="dustrial-tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  CSTooltip.prototype.setContent = function () {
    ...
    $tip.find('.dustrial-tooltip-inner')[this.options.html ? 'html' : 'text'](title)
  ...
  CSTooltip.prototype.arrow = function () {
    return (this.$arrow = this.$arrow || this.tip().find('.dustrial-tooltip-arrow'))
  }
